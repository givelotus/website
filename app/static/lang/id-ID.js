  ...
  return new Promise(function(resolve) {
    resolve({
      ...
      lotusLanding: {
        ...
        banner_subtitle:
          'Jutaan pengguna bahagia bekerja lebih baik dengan Aplikasi terintegrasi kami.',
        ...
        feature_desc1:
          'Dasbor pemirsa kami menunjukkan kepada Anda segmen yang dibangun sebelumnya seperti lokasi teratas, sumber pertumbuhan terbaru, dan bahkan nilai seumur hidup pelanggan (CLV).',
        see_detail: 'Lihat Detail',
        feature_title2: 'Semua yang Anda butuhkan adalah',
        feature_titlestrong2: 'proposisi nilai unik',
        feature_desc2:
          'Dengan fondasi teknis yang kuat, telah memungkinkan kami memanfaatkan para pakar bisnis untuk membangun ratusan peningkatan.',
        feature_title3: 'Akselerasi ke Cerdas',
        feature_titlestrong3: 'Enterprise',
        feature_desc3:
          'Kami memberdayakan tim pemasaran, penjualan, dan layanan Anda untuk berkolaborasi di seluruh siklus hidup pelanggan untuk pengalaman yang lebih bermakna dan mengesankan.',
