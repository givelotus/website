  ...
  return new Promise(function (resolve) {
    resolve({
      ...
      banner: {
        ...
        why_4:
          'If you are run such a project, and are interested in using Lotus, please apply to receive tokens through our <a class="white--text" href="https://forms.gle/j9EeY5NN57RcAoY99" target="_blank">form</a>, or on our <a class="white--text" href="https://discord.gg/KECbh3JEmm" target="_blank">discord.</a>'
      },
      lotusLanding: {
        features: {
          title: 'We are about',
        ...
        faq: {
          ...
          q2: {
            ...
            answer:
              'Enjoy browser based <a href="https://sendlotus.com" target="_blank">SendLotus.com</a> or for your mobile device you can use Lotus Vase with <a href="https://play.google.com/store/apps/details?id=org.cashweb.cashew" target="_blank"> Android</a> and <a href="https://apps.apple.com/us/app/cashew-wallet/id1539306720" target="_blank">iPhone</a>. You can also run lightweight Lotus Node for <a href="https://storage.googleapis.com/lotus-project/lotus-5.3.3-win64-setup-unsigned.exe" target="_blank">Windows</a>, <a href="https://storage.googleapis.com/lotus-project/lotus-5.3.3-osx-unsigned.dmg" target="_blank">MacOS</a> and <a href="https://storage.googleapis.com/lotus-project/lotus-5.3.3-x86_64-linux-gnu.tar.gz" target="_blank">Linux</a>. '
          },
          q3: {
