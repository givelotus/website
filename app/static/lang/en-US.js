export default () => {
  return new Promise(function (resolve) {
    resolve({
      ...
      banner: {
        why_1: 'Society struggles with efficiently funding public goods projects — with allocating resources towards work that is desparately needed but has no direct profit incentive.To this end, Lotus was created. We belive that by re- framing what money is, and challenging the ideas around how it is used, we can solve the problem of funding public goods.',
        why_2: 'Our goal is to show volunteers of charitable projects appreciation by distributing Lotus to them free-of-charge. And, as a culture, being willing to accept those tokens in return for things these volunteers need.',
        why_3: 'Our initial focus is on open source projects, and specifically the projects needed to make Lotus function and exist.However, we are looking for additional charitable projects who are willing to accept and use Lotus.We would love to speak to any volunteer - based projects that are interesting in participating.We have a particular interest in providing tokens to open source, schools, orphanages, doctors, and other public utilities.',
        why_4: 'If you are run such a project, and are interested in using Lotus, please apply to receive tokens through our <a class="white--text" href="https://forms.gle/j9EeY5NN57RcAoY99" target="_blank">form</a>, or on our <a class="white--text" href="https://discord.gg/KECbh3JEmm" target="_blank">discord.</a>',
      },
      lotusLanding: {
        features: {
          title: 'We are about',
