    ...
    resolve({
      ...
      lotusLanding: {
        features: {
          ...
          feature4: {
            title: 'Stabilność',
            description: 'Emisja nowych monet miękko podąża za podażą i popytem'
          }
        },
        story: {
          section1: {
        ...
        faq: {
          ...
          q2: {
            ...
            answer:
              'Korzystaj z opartego na przeglądarce <a href="https://sendlotus.com" target="_blank">SendLotus.com</a> lub na swoim urządzeniu mobilnym możesz użyć Lotus Vase z <a href="https://play.google.com/store/apps/details?id=org.cashweb.cashew" target="_blank">Android</a> i <a href="https://apps.apple.com/us/app/cashew-wallet/id1539306720" target="_blank">iPhone</a>. Możesz również uruchomić lekki Lotus Node dla <a href="https://storage.googleapis.com/lotus-project/lotus-4.3.3-win64-setup-unsigned.exe" target="_blank">Windows</a>, <a href="https://storage.googleapis.com/lotus-project/lotus-4.3.3-osx-unsigned.dmg" target="_blank">MacOS</a> i <a href="https://storage.googleapis.com/lotus-project/lotus-4.3.3-x86_64-linux-gnu.tar.gz" target="_blank">Linux</a>. '
          },
          q3: {
          ...
          q4: {
            ...
            answer:
              'Sprawdź otwarty kod źródłowy, który mamy <a href="https://github.com/givelotus" target="_blank">tutaj</a> i nie krępuj się skontaktować z deweloperami na naszej <a href="https://t.me/givelotus" target="_blank">grupie telegramowej</a>.'
          },
          q5: {
            question:
