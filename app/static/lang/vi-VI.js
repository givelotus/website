  ...
  return new Promise(function (resolve) {
    resolve({
      ...
      banner: {
        ...
        why_2:
          'Mục tiêu của chúng tôi là để bày tỏ lòng tri ân với các tình nguyện viên của các dự án từ thiện bằng cách gửi Lotus cho họ một cách miễn phí. Và, như là một cư xử văn hóa, sẵn lòng chấp nhận những đồng tiền này để đổi lại những thứ mà những tình nguyện viên này cần.',
        why_3:
      ...
      lotusLanding: {
        ...
        faq: {
          ...
          q2: {
            ...
            answer:
              'Nếu bạn sử dụng trình duyệt thì <a href="https://sendlotus.com" target="_blank">SendLotus.com</a> có thể sử dụng bất cứ khi nào. Hoặc đối với thiết bị di động của bạn, bạn có thể sử dụng Lotus Vase trên <a href="https://play.google.com/store/apps/details?id=org.cashweb.cashew" target="_blank"> Android</a> và <a href="https://apps.apple.com/us/app/cashew-wallet/id1539306720" target="_blank">iPhone</a>. Bạn cũng có thể chạy Lotus Node light cho <a href="https://storage.googleapis.com/lotus-project/lotus-5.3.3-win64-setup-unsigned.exe" target="_blank">Windows</a>, <a href="https://storage.googleapis.com/lotus-project/lotus-5.3.3-osx-unsigned.dmg" target="_blank">MacOS</a> và <a href="https://storage.googleapis.com/lotus-project/lotus-5.3.3-x86_64-linux-gnu.tar.gz" target="_blank">Linux</a>. '
          },
          q3: {
