export default () => {
  return new Promise(function (resolve) {
    resolve({
      ...
      banner: {
        why_1: 'Những cộng đồng gặp khó khăn trong việc cấp vốn cho các dự án công cộng - bằng việc phân bổ nguồn vốn vào những công việc cấp thiết nhưng không có lợi ích kinh tế. Với mục tiêu này, Lotus đá được tạo ra. Chúng tôi tin tưởng rầng bằng cách thay đổi nhìn nhận về đồng tiền, và thách thức những sáng kiến xung quanh việc sử dụng đồng tiền, chúng tôi có thể giải quyết được việc cấp vốn cho những dự án công cộng.',
        why_2: 'Mục tiêu của chúng tôi là để bày tỏ lòng tri ân với các tình nguyện viên của các dự án từ thiện bằng cách gửi Lotus cho họ một cách tự nguyện. Và, như là một nếp văn hóa, sắn lòng chấp nhận những đồng tiền này để đổi lại những thứ mà những tình nguyện viên này cần.',
        why_3: 'Những tập trung đầu tiên của chúng tôi là và các dự án mã nguồn mỡ, à đặc biệt là các dự án cần thiết để giúp Lotus tồn tại và phát triển. Chúng tôi sẵn lòng để thảo luận với các dự án tự nguyện mong muốn tham gia. Chúng tôi đặc biệt quan tâm cho việc cấp phát vốn cho các dự án mã nguồn mở, trường học, trại mồ côi, bác sỹ, và các tiện ích công cộng khác.',
